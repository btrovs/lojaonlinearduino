...
<head>
    ...
    <title>Contato - Arduino Amazônia</title>
...
<body>
    <header>
        <div class="cabecalho">
            <a href="index.php">
                <img src="Imagens/logo 2.png" alt="Logo da Loja">
            </a>
            <nav>
    ...
    <main>
        <div class="form-container">
            <h2>Entre em Contato com a Nossa Equipe - Deixe sua Mensagem!</h2>
            <form action="#">
                <div class="form-item">
                ...
                <div class="botao">
                    ...
                    <input type="reset" value="Limpar Formulário" class="limpar">
                </div>
            </form>
        </div>
    </main>
