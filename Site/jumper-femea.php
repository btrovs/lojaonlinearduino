...
session_start();
$PROD_ID = 12;
$PROD_NOME = "Jumper Fêmea/Fêmea x 20 Unidades";
$PROD_PRECO = 12.00;
$PROD_IMG = "Imagens/Jumper Fêmea - Fêmea x20 uni 20cm.jpg";
$PROD_CATEGORIA = "Cabos, Conectores";
...
<body>
    ...
    <main class="produto-container">
        ...
        <div class="info-produto">
            ...
            <p class="descricao">Kit com 20 cabos Jumper tipo Fêmea-Fêmea de 20cm. Essenciais para conexões em protoboards e sensores.</p>
    ...
    <section class="descricao-detalhada"><h2>Especificações Técnicas</h2><ul><li>- Tipo: Fêmea x Fêmea</li><li>- Quantidade: 20 cabos</li><li>- Comprimento: 20 cm</li></ul></section>
    <section class="produtos-relacionados"><h2>Você também pode gostar</h2><div class="produtos-container"><a href="kit-resistor.php" class="produto-card"><img src="Imagens/Kit resistor 1-4W x10 Unidades.jpg" alt="Resistor"><h3>Kit Resistor</h3><p class="preco">R$ 4,00</p></a><a href="protoboard.php" class="produto-card"><img src="Imagens/Protoboard 830 Pontos.jpg" alt="Proto"><h3>Protoboard</h3><p class="preco">R$ 30,00</p></a></div></section>
