...
// Detalhes fixos do produto (ID 12)
$PROD_ID = 12;
$PROD_NOME = "Jumper Fêmea/Fêmea x 20 Unidades de 20cm";
// Obtém dados do produto (sem promoção)
$PRODUTO = [
    "preco" => 12.00, // Preço Normal
    "img" => "Imagens/Jumper Fêmea - Fêmea x20 uni 20cm.jpg",
    "categoria" => "Cabos, Jumpers",
...
<body>
    ...
    <main class="produto-container">
        ...
        <div class="info-produto">
            ...
            <p class="descricao">
                Pacote com 20 unidades de jumpers fêmea-fêmea de 20cm, essenciais para conectar componentes e módulos a headers de placas como Arduino, Raspberry Pi e protoboards. Possuem terminais de alta qualidade para conexões seguras e reversíveis.
            </p>
    ...
    <section class="descricao-detalhada">
        ...
        <ul>
            <li>- Tipo: Jumper Fêmea-Fêmea</li>
            <li>- Comprimento: 20cm</li>
            <li>- Quantidade: 20 unidades (cores variadas)</li>
            <li>- Compatibilidade: Placas de desenvolvimento, sensores e módulos com pinos macho.</li>
        </ul>
        <table>
    ...
    <section class="produtos-relacionados">
        ...
        <div class="produtos-container">
            ...
            <a href="modulo-sensor.php" class="produto-card">
                <img src="Imagens/Módulo Sensor de Chuva.png" alt="Módulo Sensor de Chuva">
