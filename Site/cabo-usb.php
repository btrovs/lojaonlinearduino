...
// Detalhes fixos do produto (ID 5)
$PROD_ID = 5;
$PROD_NOME = "Cabo USB-C 7.1A Leon 1000mm";
$PRODUTO = [
    "preco" => 18.00,
    "img" => "Imagens/Cabo Usb-C 7.1A Leon 1000mm.png",
    "categoria" => "Cabos, Acessórios",
...
<body>
    ...
    <main class="produto-container">
        ...
        <div class="info-produto">
            ...
            <p class="descricao">
                Cabo USB-C para carregamento de celular ou transferencias de dados.
            </p>

            <h2 class="preco"><?php if ($PROD_PROMOCAO && $PROD_PRECO_ANTIGO > 0): ?>
        ...
        <table>
            ...
            <tr>
                ...
                <div class="info-adicional">
                    <strong>Categorias:</strong> Cabos, Acessórios </p>
                </div>
            </tr>
        </table>
    </section>
    ...
    <section class="produtos-relacionados">
        ...
        <div class="produtos-container">
            ...
            <a href="cabo-micro.php" class="produto-card">
                <img src="Imagens/Cabo Micro USB para Esp32, Esp8266 e Arduino Leonardo.jpeg" alt="Cabo Micro USB">
                <h3>Cabo Micro USB para Esp32, Esp8266 e Arduino Leonardo</h3>
                <p class="preco">R$22,00</p>
            </a>

            <a href="arduino-nano.php" class="produto-card">
                <img src="Imagens/Arduino Nano V3.0 Entrada USB-C (sem cabo).jpg" alt="Arduino Nano V3.0">
