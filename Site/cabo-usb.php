...
session_start();
$PROD_ID = 5;
$PROD_NOME = "Cabo USB-C 7.1A Leon 1000mm";
$PROD_PRECO = 18.00;
$PROD_IMG = "Imagens/Cabo Usb-C 7.1A Leon 1000mm.png"; 
...
<body>
    ...
    <main class="produto-container">
        ...
        <div class="info-produto">
            ...
            <p class="descricao">Cabo USB-C reforçado para carregamento e dados.</p>
    ...
    <section class="descricao-detalhada"><h2>Especificações Técnicas</h2><ul><li>- Tipo: USB-C</li><li>- Comprimento: 1 Metro</li><li>- Corrente: 7.1A</li></ul></section>
    <section class="produtos-relacionados"><h2>Você também pode gostar</h2><div class="produtos-container"><a href="arduino-nano.php" class="produto-card"><img src="Imagens/Arduino Nano V3.0 Entrada USB-C (sem cabo).jpg" alt="Nano"><h3>Arduino Nano</h3><p class="preco">R$ 45,50</p></a><a href="kit-uno.php" class="produto-card"><img src="Imagens/Kit Uno Iniciante – 80 Peças para Arduino.png" alt="Kit"><h3>Kit Uno</h3><p class="preco">R$ 70,00</p></a></div></section>
