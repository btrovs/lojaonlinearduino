...
// Detalhes fixos do produto (ID 1)
$PROD_ID = 1;
$PROD_NOME = "Arduino Nano V3.0 Entrada USB-C (sem cabo)";

// Detalhes completos do produto
$PRODUTO = [
    "preco" => 45.50, // Preço Normal
    // CORREÇÃO: Nome da imagem ajustado para ser mais simples e menos propenso a erros
    "img" => "Imagens/Arduino Nano V3.0 Entrada USB-C (sem cabo).jpg",
    "categoria" => "Arduino, Placas",
...
<body>
    ...
    <main class="produto-container">
        ...
        <div class="info-produto">
            ...
            <p class="descricao">
                O Arduino Nano V3.0 (compatível) com entrada USB-C é uma versão compacta e completa da placa de desenvolvimento, ideal para projetos que exigem pouco espaço. Possui o mesmo microcontrolador ATmega328P do UNO, mas em um formato reduzido, e a conveniência do conector USB-C.
            </p>
    ...
    <section class="descricao-detalhada">
        ...
        <ul>
            ...
            <li>- Tensão de Entrada (Recomendada): 7-12V</li>
            <li>- Portas Digitais I/O: 14 (6 com saída PWM)</li>
            <li>- Portas Analógicas de Entrada: 8</li>
            <li>- Conector: USB-C</li>
            <li>- Velocidade de Clock: 16 MHz</li>
        </ul>
        <table>
    ...
    <script>
        document.querySelector('.form-carrinho-adicionar').addEventListener('submit', async e => {
            ...
            if (json.sucesso) {
                ...
                setTimeout(() => {
                    ...
                    botao.textContent = textoOriginal; // Retorna ao original
                }, 1200);
            } else {
        ...
        async function atualizarCabecalho() {
            // Usa contador_carrinho.php para pegar o status (como no produtos.php e carrinho.php)
