...
$PROD_PRECO = 4.00;
$PROD_IMG = "Imagens/Kit resistor 1-4W x10 Unidades.jpg";
$PROD_CATEGORIA = "Componentes";
...
<body>
    ...
    <main class="produto-container">
        ...
        <div class="info-produto">
            ...
            <p class="descricao">Kit com 10 resistores de 1/4W para controle de corrente.</p>
    ...
    <section class="descricao-detalhada"><h2>Especificações Técnicas</h2><ul><li>- Potência: 1/4W</li><li>- Quantidade: 10</li></ul></section>
    <section class="produtos-relacionados"><h2>Você também pode gostar</h2><div class="produtos-container"><a href="leds.php" class="produto-card"><img src="Imagens/Kit 20 Leds 5mm difusos coloridos.jpg" alt="LEDs"><h3>Kit LEDs</h3><p class="preco">R$ 10,00</p></a><a href="protoboard.php" class="produto-card"><img src="Imagens/Protoboard 830 Pontos.jpg" alt="Proto"><h3>Protoboard</h3><p class="preco">R$ 30,00</p></a></div></section>
