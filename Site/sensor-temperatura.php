...
// Detalhes fixos do produto (ID 20)
$PROD_ID = 20;
$PROD_NOME = "Sensor de Temperatura LM35 DZ";
// Obtém dados do produto (sem promoção)
$PRODUTO = [
    "preco" => 8.00, // Preço Normal
    "img" => "Imagens/Sensor de Temperatura LM35 DZ.jpg",
    "categoria" => "Sensores, Componentes",
...
<body>
    ...
    <main class="produto-container">
        ...
        <div class="info-produto">
            ...
            <p class="descricao">
                O sensor LM35 DZ é um circuito integrado que mede a temperatura com precisão e facilidade de uso. Sua saída de tensão é linearmente proporcional à temperatura em graus Celsius. Ele não requer calibração externa e é ideal para projetos com Arduino que precisam monitorar o ambiente com baixo consumo de energia.
            </p>
    ...
    <section class="descricao-detalhada">
        ...
        <ul>
            <li>- Chip: LM35 DZ</li>
            <li>- Faixa de Medição: 0°C a +100°C</li>
            <li>- Precisão: 0,5°C em temperatura ambiente (25°C)</li>
            <li>- Saída: Tensão linear (10mV/°C)</li>
            <li>- Tensão de Operação: 4V a 20V</li>
            <li>- Encapsulamento: TO-92</li>
        </ul>
        <table>
    ...
    <section class="produtos-relacionados">
        ...
        <div class="produtos-container">
            ...
            <a href="arduino-nano.php" class="produto-card">
                <img src="Imagens/Arduino Nano V3.0 Entrada USB-C (sem cabo).jpg" alt="Arduino Nano V3.0 Entrada USB-C (sem cabo)">
                <h3>Arduino Nano V3.0 Entrada USB-C (sem cabo)</h3>
