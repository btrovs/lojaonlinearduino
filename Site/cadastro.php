...
// Lógica do Carrinho (Contagem e Prévia)
$contador = 0;
$total = 0.0;
$itensCarrinho = [];
...
<head>
    ...
    <title>Cadastro - Arduino Amazônia</title>
    ...
    <style>
        /* --- CSS DO MINI CARRINHO (Padronizado) --- */
        .carrinho-icone {
            position: relative;
        ...
        <div class="barra-pesquisa-container">
            ...
            <div class="carrinho-icone">
                <a href="carrinho.php">
                    ...
                    <?php if($contador > 0): ?>
                        <span style="background: red; color: white; border-radius: 50%; padding: 2px 6px; font-size: 12px; vertical-align: top; margin-left: -10px;">
                            <?= $contador ?>
                        </span>
                    <?php endif; ?>
                </a>
        ...
        <div class="form-container">
            ...
            <form action="#" method="post">
                ...
                <div class="form-item">
                    ...
                    <input type="password" id="confirmar" name="confirmar" class="input-padrao" required>
                    <p id="mensagem-senha"></p>
                </div>

                <div class="form-item">
                    <label for="data-nasc">Data de Nascimento</label>
                    <input type="date" id="data-nasc" name="data-nasc" class="input-padrao" required>
                </div>

                <fieldset class="multipla">
