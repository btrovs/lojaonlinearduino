...
session_start();
$PROD_ID = 9;
$PROD_NOME = "Display Gráfico LCD 128x64";
$PROD_PRECO = 60.00;
$PROD_IMG = "Imagens/Display Gráfico LCD 128×64 para Impressora 3D RAMPS RepRap.jpg";
...
<body>
    ...
    <main class="produto-container">
        ...
        <div class="info-produto">
            ...
            <p class="descricao">Display gráfico LCD para impressoras 3D e projetos complexos.</p>
    ...
    <section class="descricao-detalhada"><h2>Especificações Técnicas</h2><ul><li>- Resolução: 128x64</li><li>- Compatibilidade: RAMPS 1.4</li></ul></section>
    <section class="produtos-relacionados"><h2>Você também pode gostar</h2><div class="produtos-container"><a href="arduino.php" class="produto-card"><img src="Imagens/arduino 3.png" alt="Arduino"><h3>Arduino Uno</h3><p class="preco">R$ 55,00</p></a><a href="protoboard.php" class="produto-card"><img src="Imagens/Protoboard 830 Pontos.jpg" alt="Proto"><h3>Protoboard</h3><p class="preco">R$ 30,00</p></a></div></section>
