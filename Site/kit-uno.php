...
// Detalhes fixos do produto (ID 2 do produtos.php)
$PROD_ID = 2;
$PROD_NOME = "Kit Uno Iniciante – 80 Peças para Arduino";
// Obtém dados do produto (usando a matriz expandida)
$PRODUTO = [
    "preco" => 70.00,
    "img" => "Imagens/Kit Uno Iniciante – 80 Peças para Arduino.png",
    "categoria" => "Kits Inicantes",
    "disponibilidade" => "Esgotado", // MANTIDO como Esgotado
    "promocao" => false,
    "preco_antigo" => 0.00
];
...
<head>
    ...
    <style>
        ...
        /* NOVO ESTILO: Texto de indisponibilidade em vermelho */
        .esgotado-text {
            color: #e74c3c;
            font-weight: bold;
        }
...
<body>
    ...
    <main class="produto-container">
        ...
        <div class="info-produto">
            ...
            <p class="descricao">
                O Kit Uno Iniciante com 80 peças é a maneira perfeita de mergulhar no mundo do Arduino. Inclui a placa Arduino UNO R3 (compatível), protoboard, jumpers, LEDs, resistores e um guia para os primeiros projetos.
            </p>
    ...
    <section class="descricao-detalhada">
        ...
        <ul>
            <li>- Placa: Arduino UNO R3 (Compatível)</li>
            <li>- Componentes: 80 peças, incluindo LEDs, resistores, jumpers, sensores e protoboard.</li>
            <li>- Guia: Acompanha guia de primeiros passos em PDF.</li>
        </ul>
        <table>
    ...
    <section class="produtos-relacionados">
        ...
        <div class="produtos-container">
            ...
            <a href="arduino.php" class="produto-card">
                <img src="Imagens/arduino 3.jpg" alt="Placa Arduino UNO R3">
    ...
    <script>
        document.querySelector('.form-carrinho-adicionar').addEventListener('submit', async e => {
            ...
            if (botao.disabled) return; // Não envia se estiver indisponível
            ...
            if (json.sucesso) {
                ...
                // Para o botão indisponível, a cor original é a cor cinza que definimos no HTML
                const corOriginal = botao.style.backgroundColor || "#1c593a";
