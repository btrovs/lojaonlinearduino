...
session_start();
$PROD_ID = 2;
$PROD_NOME = "Kit Uno Iniciante – 80 Peças para Arduino";
$PROD_PRECO = 70.00;
$PROD_IMG = "Imagens/Kit Uno Iniciante – 80 Peças para Arduino.png"; 
$PROD_CATEGORIA = "Kits, Iniciante";
$PROD_DISPONIBILIDADE = "Esgotado"; 
...
<body>
    ...
    <main class="produto-container">
        ...
        <div class="info-produto">
            ...
            <p class="disponibilidade">Disponibilidade: <span style="color: red; font-weight: bold;"><?= $PROD_DISPONIBILIDADE ?></span></p>
            <p class="descricao">Kit completo para iniciantes no mundo da robótica. Contém placa Uno R3 compatível, protoboard, LEDs, resistores, jumpers e diversos sensores.</p>
            ...
            <form action="salvar_carrinho.php" method="POST">
                <div class="acoes" style="display: flex; gap: 10px; align-items: center;">
                    <input type="number" name="quantidade" value="1" disabled style="width: 60px; padding: 15px; border: 1px solid #ccc; border-radius: 5px; font-size: 16px;">
                    <button type="button" style="background-color: #999; color: white; border: none; padding: 15px 30px; cursor: not-allowed; font-size: 16px; border-radius: 25px; font-weight: bold; width: 100%;">🚫 Indisponível</button>
                </div>
            </form>
        </div>
    </main>
    ...
    <section class="descricao-detalhada">
        ...
        <ul>
            <li>1x Placa Uno R3 Compatível</li>
            <li>1x Cabo USB</li>
            <li>1x Protoboard 400 Pontos</li>
            <li>10x LEDs Coloridos</li>
            <li>10x Resistores</li>
            <li>1x Conjunto de Jumpers</li>
            <li>1x Sensor de Luz LDR</li>
        </ul>
    </section>
