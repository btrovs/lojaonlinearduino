...
// Detalhes fixos do produto (ID 3)
$PROD_ID = 3;
$PROD_NOME = "Micro Motor 3-6V";
$PROD_PRECO = 12.00;
$PROD_CATEGORIA = "Motores, Robótica";
?>
<!DOCTYPE html>
<html lang="pt-br">
...
<body>
    ...
    <main class="produto-container">
        <div class="img-produto">
            <img src="Imagens/Micro Motor 3-6V.webp" alt="<?= htmlspecialchars($PROD_NOME) ?>">
        </div>
        ...
        <div class="info-produto">
            ...
            <p class="descricao">
                Motor DC pequeno, ideal para projetos de robótica, como carrinhos ou ventiladores. Opera com baixa tensão (3V a 6V) e é fácil de integrar com Arduino e outros microcontroladores.
            </p>
    ...
    <section class="descricao-detalhada">
        ...
        <ul>
            <li>- Tensão de Operação: 3V a 6V DC</li>
            <li>- Corrente sem Carga: 150mA (em 6V)</li>
            <li>- Velocidade: Alta rotação</li>
        </ul>
        <table>
