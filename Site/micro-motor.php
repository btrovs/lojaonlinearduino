...
session_start();
$PROD_ID = 3;
$PROD_NOME = "Micro Motor 3-6V";
$PROD_PRECO = 12.00;
$PROD_IMG = "Imagens/Micro Motor 3-6V.webp";
$PROD_CATEGORIA = "Motores";
...
<body>
    ...
    <main class="produto-container">
        ...
        <div class="info-produto">
            ...
            <p class="descricao">Micro motor DC ideal para robótica e projetos escolares.</p>
    ...
    <section class="descricao-detalhada"><h2>Especificações Técnicas</h2><ul><li>- Tensão: 3-6V</li><li>- Rotação: Alta</li><li>- Eixo: 2mm</li></ul></section>
    <section class="produtos-relacionados"><h2>Você também pode gostar</h2><div class="produtos-container"><a href="kit-robo.php" class="produto-card"><img src="Imagens/Kit Montagem Robô Seguidor de Linha 2 Rodas.jpg" alt="Robo"><h3>Kit Robô</h3><p class="preco">R$ 150,00</p></a><a href="arduino.php" class="produto-card"><img src="Imagens/arduino 3.png" alt="Arduino"><h3>Arduino Uno</h3><p class="preco">R$ 55,00</p></a></div></section>
