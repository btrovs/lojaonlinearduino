...
// Detalhes fixos do produto (ID 14)
$PROD_ID = 14;
$PROD_NOME = "Kit Montagem Robô Seguidor de Linha 2 Rodas";
// Obtém dados do produto (sem promoção)
$PRODUTO = [
    "preco" => 150.00, // Preço Normal
    "img" => "Imagens/Kit Montagem Robô Seguidor de Linha 2 Rodas.jpg",
...
<body>
    ...
    <main class="produto-container">
        ...
        <div class="info-produto">
            ...
            <p class="descricao">
                Kit completo para montar seu próprio robô seguidor de linha com chassi de 2 rodas. Inclui todos os componentes essenciais como motores, rodas, suporte de bateria, sensor de linha e a estrutura acrílica do chassi. Ideal para competições e aprendizado de robótica.
            </p>
    ...
    <section class="descricao-detalhada">
        ...
        <ul>
            <li>- Tipo de Robô: Seguidor de Linha (Line Follower)</li>
            <li>- Chassis: Acrílico de 2 Rodas</li>
            <li>- Componentes Inclusos: Motores DC, rodas, chassi acrílico, suportes, sensor infravermelho de linha.</li>
            <li>- Requerimentos Adicionais (Não inclusos): Placa microcontroladora (ex: Arduino UNO), ponte H (driver de motor), baterias.</li>
        </ul>
        <table>
