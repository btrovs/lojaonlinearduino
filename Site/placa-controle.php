...
session_start();
$PROD_ID = 17;
$PROD_NOME = "Placa de Controle de Nível Automático";
$PROD_PRECO = 75.00;
$PROD_IMG = "Imagens/Placa Controle Nível Automático Caixa Água Liga E Desliga Bomba.jpg";
$PROD_CATEGORIA = "Placas";
...
<body>
    ...
    <main class="produto-container">
        ...
        <div class="info-produto">
            ...
            <p class="descricao">Placa para controle automático de bomba de água.</p>
    ...
    <section class="descricao-detalhada"><h2>Especificações Técnicas</h2><ul><li>- Tensão: Bivolt</li><li>- Uso: Caixas d'água</li></ul></section>
    <section class="produtos-relacionados"><h2>Você também pode gostar</h2><div class="produtos-container"><a href="fonte-arduino.php" class="produto-card"><img src="Imagens/Fonte 9V 2A Arduino e uso geral.jpg" alt="Fonte"><h3>Fonte 9V</h3><p class="preco">R$ 27,50</p></a><a href="protoboard.php" class="produto-card"><img src="Imagens/Protoboard 830 Pontos.jpg" alt="Proto"><h3>Protoboard</h3><p class="preco">R$ 30,00</p></a></div></section>
