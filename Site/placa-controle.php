...
// Detalhes fixos do produto (ID 17)
$PROD_ID = 17;
$PROD_NOME = "Placa de Controle de Nível Automático Caixa d'Água Liga e Desliga Bomba";
// Obtém dados do produto (sem promoção)
$PRODUTO = [
    "preco" => 75.00, // Preço Normal
    "img" => "Imagens/Placa Controle Nível Automático Caixa Água Liga E Desliga Bomba.jpg",
    "categoria" => "Placas, Controle",
...
<body>
    ...
    <main class="produto-container">
        ...
        <div class="info-produto">
            ...
            <p class="descricao">
                Placa pronta para controlar o nível de água em caixas d'água ou cisternas, acionando ou desligando bombas automaticamente. Ideal para automação residencial e industrial leve, ajudando a evitar o desperdício ou que a bomba funcione a seco. Simples de instalar e operar, não requer conhecimento em programação Arduino.
            </p>
    ...
    <section class="descricao-detalhada">
        ...
        <ul>
            <li>- Função: Controle Automático de Nível (Liga/Desliga Bomba)</li>
            <li>- Aplicação: Caixa d'Água, Cisterna, Reservatórios</li>
            <li>- Compatibilidade de Tensão: 110V/220V (A placa em si opera em baixa tensão, mas controla o relé da bomba)</li>
            <li>- Sensores: Requer sensores de nível (boias ou eletrônicos, não inclusos).</li>
            <li>- Instalação: Fácil, com bornes de conexão para sensores e bomba.</li>
        </ul>
        <table>
    ...
    <section class="produtos-relacionados">
        ...
        <div class="produtos-container">
            ...
            <a href="modulo-sensor.php" class="produto-card">
                <img src="Imagens/Módulo sensor de chuva.png" alt="Módulo de Sensor de Chuva">
                <h3>Módulo de Sensor de Chuva</h3>
                <p class="preco">R$15,00</p>
            </a>

            <a href="fonte-arduino.php" class="produto-card">
                <img src="Imagens/Fonte 9V 2A Arduino e uso geral.jpg" alt="Fonte 9V 2A Arduino e Uso Geral">
