...
// Detalhes fixos do produto (ID 10)
$PROD_ID = 10;
$PROD_NOME = "Display Led 7 Segmentos 1 Dígito – Cátodo";
// Obtém dados do produto (sem promoção e com preço normal)
$PRODUTO = [
    "preco" => 4.50, // Preço Normal
    "img" => "Imagens/Display Led 7 Segmentos 1 Dígito – Cátodo.jpg",
    "categoria" => "Displays",
...
// Calcula desconto para o badge (será 0 porque $PROD_PROMOCAO é false)
$desconto = 0;
...
<body>
    ...
    <main class="produto-container">
        ...
        <div class="info-produto">
            ...
            <p class="descricao">
                Este é um display de 7 segmentos de 1 dígito (vermelho), ideal para exibir números em projetos com Arduino e microcontroladores. Por ser do tipo Cátodo Comum, simplifica a ligação em muitas aplicações. É muito utilizado em relógios digitais, contadores e indicadores simples.
            </p>
    ...
    <section class="descricao-detalhada">
        ...
        <ul>
            <li>- Tipo: Display de 7 Segmentos</li>
            <li>- Dígitos: 1 Dígito</li>
            <li>- Cor do LED: Vermelho</li>
            <li>- Configuração: Cátodo Comum</li>
            <li>- Tensão de Operação: 1.8V a 2.2V (Tipicamente para LEDs vermelhos)</li>
            <li>- Corrente Máxima por Segmento: 20mA (Recomendado o uso de resistores limitadores)</li>
        </ul>
        <table>
    ...
    <section class="produtos-relacionados">
        ...
        <div class="produtos-container">
            ...
            <a href="arduino.php" class="produto-card">
                <img src="Imagens/arduino 3.png" alt="Placa Arduino UNO R3">
                <h3>Placa Arduino UNO R3 (Compatível)</h3>
                <p class="preco">R$55,00</p>
            </a>

            <a href="display-grafico.php" class="produto-card">
                <img src="Imagens/Display Gráfico LCD 128×64 para Impressora 3D RAMPS RepRap.jpg" alt="Display Gráfico LCD 128x64">
                <h3>Display Gráfico LCD 128x64</h3>
