...
// Detalhes fixos do produto (ID 18)
$PROD_ID = 18;
$PROD_NOME = "Protoboard 830 Pontos";
// Obtém dados do produto (usando a matriz expandida)
$PRODUTO = [
    "preco" => 30.00,
    "img" => "Imagens/Protoboard 830 Pontos.jpg",
    "categoria" => "Protoboard, Placas",
    "disponibilidade" => "Em Estoque", // Status
    "promocao" => false,
    "preco_antigo" => 0.00
];
...
<body>
    ...
    <main class="produto-container">
        ...
        <div class="info-produto">
            ...
            <p class="descricao">
                A Protoboard de 830 pontos é essencial para a prototipagem de circuitos eletrônicos. Permite montar e desmontar projetos rapidamente, sem a necessidade de solda. Compatível com a maioria dos componentes e módulos Arduino.
            </p>
    ...
    <section class="descricao-detalhada">
        ...
        <ul>
            <li>- Total de Pontos: 830 pontos</li>
            <li>- Material: Plástico ABS de alta resistência e contatos metálicos.</li>
            <li>- Barras de Energia: Duas laterais com barramentos para alimentação.</li>
            <li>- Tipo: Padrão, ideal para Arduino e projetos de eletrônica geral.</li>
            <li>- Cor: Branca</li>
        </ul>
        <table>
    ...
    <section class="produtos-relacionados">
        ...
        <div class="produtos-container">
            ...
            <a href="display-led.php" class="produto-card">
                <img src="Imagens/Display Led 7 Segmentos 1 Dígito – Cátodo.jpg" alt="Display Led 7 Segmentos 1 Dígito – Cátodo">
