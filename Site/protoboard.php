...
$PROD_PRECO = 30.00;
$PROD_IMG = "Imagens/Protoboard 830 Pontos.jpg";
$PROD_CATEGORIA = "Placas, Protótipos";
...
<body>
    ...
    <main class="produto-container">
        ...
        <div class="info-produto">
            ...
            <p class="descricao">Protoboard com 830 furos, essencial para montagem e testes de circuitos eletrônicos sem solda.</p>
    ...
    <section class="descricao-detalhada">
        ...
        <ul>
            ...
            <li>- Base adesiva: Sim</li>
            <li>- Dimensões: 16.5 x 5.5 cm</li>
        </ul>
    </section>
