...
// Detalhes fixos do produto (ID 16)
$PROD_ID = 16;
$PROD_NOME = "Módulo de Sensor de Chuva";
// Obtém dados do produto (usando a matriz expandida)
$PRODUTO = [
    "preco" => 15.00,
    "img" => "Imagens/Módulo Sensor de Chuva.png",
    "categoria" => "Módulos, Sensores",
...
<body>
    ...
    <main class="produto-container">
        ...
        <div class="info-produto">
            ...
            <p class="descricao">
                Módulo sensor de chuva para projetos de detecção de água. Ideal para sistemas de irrigação inteligentes, automação residencial e monitoramento climático. Fácil integração com Arduino.
            </p>
    ...
    <section class="descricao-detalhada">
        ...
        <ul>
            <li>- Tensão de Operação: 3.3V a 5V</li>
            <li>- Saída: Digital (0 ou 1) e Analógica</li>
            <li>- Indicador LED: Sim (alimentação e saída digital)</li>
    ...
    <section class="produtos-relacionados">
        ...
        <div class="produtos-container">
            ...
            <a href="modulo-gas.php" class="produto-card">
                <img src="Imagens/Módulo Sensor de Gás Inflamável e Fumaça MQ-2 2.jpg" alt="Módulo de Sensor de Gás">
                <h3>Módulo de Sensor de Gás Inflamável e Fumaça MQ-2</h3>
