...
// Detalhes fixos do produto (ID 15)
$PROD_ID = 15;
$PROD_NOME = "Módulo de Sensor de Gás Inflamável e Fumaça MQ-2";
// Obtém dados do produto (usando a matriz expandida)
$PRODUTO = [
    "preco" => 18.50,
    "img" => "Imagens/Módulo Sensor de Gás Inflamável e Fumaça MQ-2 2.jpg",
    "categoria" => "Módulo, Sensores",
    "disponibilidade" => "Em Estoque", // STATUS ATUALIZADO
    "promocao" => false,
    "preco_antigo" => 0.00
];
...
<body>
    ...
    <main class="produto-container">
        ...
        <div class="info-produto">
            ...
            <p class="descricao">
                O módulo sensor de gás MQ-2 é capaz de detectar diversos gases inflamáveis como propano, metano, butano, GLP, álcool, hidrogênio e fumaça. Ideal para sistemas de segurança, monitoramento de qualidade do ar e projetos de automação.
            </p>
    ...
    <section class="descricao-detalhada">
        ...
        <ul>
            ...
            <li>- Detecção: Gases inflamáveis (Metano, Propano, Butano, GLP, Álcool, Hidrogênio) e Fumaça</li>
            <li>- Saída: Digital e Analógica</li>
            <li>- Compatibilidade: Arduino, Raspberry Pi, ESP32, ESP8266</li>
        </ul>
        <table>
    ...
    <section class="produtos-relacionados">
        ...
        <div class="produtos-container">
            ...
            <a href="sensor-temperatura.php" class="produto-card">
                <img src="Imagens/Sensor de Temperatura LM35 DZ.jpg" alt="Placa Arduino UNO R3">
