...
session_start();
$PROD_ID = 15;
$PROD_NOME = "Módulo Sensor de Gás Inflamável e Fumaça MQ-2";
$PROD_PRECO = 18.50;
$PROD_IMG = "Imagens/Módulo Sensor de Gás Inflamável e Fumaça MQ-2 2.jpg";
$PROD_CATEGORIA = "Módulos, Sensores";
...
<body>
    ...
    <main class="produto-container">
        ...
        <div class="info-produto">
            ...
            <p class="descricao">O módulo MQ-2 detecta gás GLP, propano, metano, hidrogênio e fumaça. Essencial para segurança residencial.</p>
    ...
    <section class="descricao-detalhada">
        ...
        <ul>
            <li>- Modelo: MQ-2</li>
            <li>- Detecção: Gases Inflamáveis e Fumaça</li>
            <li>- Tensão: 5V</li>
            <li>- Saída: Analógica e Digital</li>
        </ul>
    </section>
