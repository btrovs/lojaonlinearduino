...
$PROD_PRECO = 55.00;
$PROD_IMG = "Imagens/arduino 3.png"; 
...
<body>
    ...
    <main class="produto-container">
        ...
        <div class="info-produto">
            ...
            <p class="descricao">A Placa Arduino UNO R3 é a placa de desenvolvimento mais popular e versátil. Ideal para iniciantes em eletrônica e programação. Possui microcontrolador ATmega328P.</p>
    ...
    <section class="descricao-detalhada">
        ...
        <ul>
            ...
            <li>- Conexão: USB Tipo B (Cabo de Impressora)</li>
        </ul>
    </section>
