...
// Detalhes fixos do produto (ID 11)
$PROD_ID = 11;
$PROD_NOME = "Fonte 9V 2A Arduino e Uso Geral";
// Obtém dados do produto (sem promoção)
$PRODUTO = [
    "preco" => 27.50, // Preço Normal
    "img" => "Imagens/Fonte 9V 2A Arduino e uso geral.jpg",
    "categoria" => "Fontes, Acessórios",
...
<body>
    ...
    <main class="produto-container">
        ...
        <div class="info-produto">
            ...
            <p class="descricao">
                Fonte de alimentação universal e estabilizada, ideal para alimentar a maioria das placas Arduino (UNO, MEGA) e outros projetos eletrônicos que demandam 9V DC com corrente de até 2 Amperes. Possui plug P4 padrão.
            </p>
    ...
    <section class="descricao-detalhada">
        ...
        <ul>
            <li>- Tensão de Saída: 9V DC</li>
            <li>- Corrente Máxima: 2 Amperes (2000mA)</li>
            <li>- Tensão de Entrada: 100V-240V AC (Bivolt automático)</li>
            <li>- Plug: P4 (2.1mm x 5.5mm) padrão Arduino</li>
            <li>- Polaridade: Positivo no Centro</li>
        </ul>
        <table>
    ...
    <section class="produtos-relacionados">
        ...
        <div class="produtos-container">
            ...
            <a href="modulo-wifi.php" class="produto-card">
                <img src="Imagens/Módulo WiFi ESP8266 NodeMcu LiLon CH340G.jpg" alt="Módulo WiFi ESP8266 NodeMcu">
