...
$PROD_PRECO = 27.50;
$PROD_IMG = "Imagens/Fonte 9V 2A Arduino e uso geral.jpg";
$PROD_CATEGORIA = "Fontes";
...
<body>
    ...
    <main class="produto-container">
        ...
        <div class="info-produto">
            ...
            <p class="descricao">Fonte de alimentação 9V 2A Bivolt automática.</p>
    ...
    <section class="descricao-detalhada"><h2>Especificações Técnicas</h2><ul><li>- Tensão: 9V</li><li>- Corrente: 2A</li><li>- Plug: P4</li></ul></section>
