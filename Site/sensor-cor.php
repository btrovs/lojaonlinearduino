...
$PROD_PRECO = 45.00;
$PROD_IMG = "Imagens/Sensor de Cor TCS3200.jpg";
$PROD_CATEGORIA = "Sensores";
...
<body>
    ...
    <main class="produto-container">
        ...
        <div class="info-produto">
            ...
            <p class="descricao">Sensor de Cor TCS3200 capaz de identificar uma ampla gama de cores. Ideal para robótica e automação.</p>
    ...
    <section class="descricao-detalhada">
        ...
        <ul>
            <li>- Chip: TCS3200</li>
            <li>- Tensão: 2.7V a 5.5V</li>
            <li>- LEDs: 4 LEDs brancos para iluminação</li>
            <li>- Saída: Frequência proporcional à cor</li>
        </ul>
    </section>
