...
// Detalhes fixos do produto (ID 19)
$PROD_ID = 19;
$PROD_NOME = "Sensor de Cor TCS3200";
// Obtém dados do produto (sem promoção)
$PRODUTO = [
    "preco" => 45.00, // Preço Normal
    "img" => "Imagens/Sensor de Cor TCS3200.jpg",
    "categoria" => "Sensores, Robótica",
...
<body>
    ...
    <main class="produto-container">
        ...
        <div class="info-produto">
            ...
            <p class="descricao">
                O Sensor de Cor TCS3200 é um módulo capaz de detectar uma ampla gama de cores visíveis, transformando a intensidade de luz em frequências de onda quadradas. É ideal para projetos de classificação de objetos por cor em robótica, automação e identificação de cores em geral.
            </p>
    ...
    <section class="descricao-detalhada">
        ...
        <ul>
            <li>- Chip: TCS3200</li>
            <li>- Tensão de Operação: 2.7V a 5.5V</li>
            <li>- Comunicação: Saída de frequência (onda quadrada)</li>
            <li>- Detecção: Identifica cores RGB (Vermelho, Verde, Azul)</li>
            <li>- Aplicação: Robótica, classificação de materiais, sistemas de medição de cor.</li>
        </ul>
        <table>
    ...
    <section class="produtos-relacionados">
        ...
        <div class="produtos-container">
            ...
            <a href="arduino.php" class="produto-card">
                <img src="Imagens/Módulo WiFi ESP8266 NodeMcu LiLon CH340G.jpg" alt="Módulo WiFi ESP8266 NodeMcu LiLon CH340G">
            ...
            <a href="kit-robo.php" class="produto-card">
                ...
                <h3>Kit Montagem Robô Seguidor de Linha</h3>
