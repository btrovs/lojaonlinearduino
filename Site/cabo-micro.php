...
session_start();
$PROD_ID = 22;
$PROD_NOME = "Cabo Micro USB para Arduino Leonardo";
$PROD_PRECO = 22.00;
$PROD_IMG = "Imagens/Cabo Micro USB para Esp32, Esp8266 e Arduino Leonardo.jpeg";
$PROD_CATEGORIA = "Cabos";
...
<body>
    ...
    <main class="produto-container">
        ...
        <div class="info-produto">
            ...
            <p class="descricao">Cabo Micro USB de alta qualidade, compatível com Arduino Leonardo, ESP32 e outros módulos.</p>
    ...
    <section class="descricao-detalhada"><h2>Especificações Técnicas</h2><ul><li>- Tipo: Micro USB</li><li>- Cor: Azul</li><li>- Comprimento: 50cm</li></ul></section>
    <section class="produtos-relacionados"><h2>Você também pode gostar</h2><div class="produtos-container"><a href="cabo-usb.php" class="produto-card"><img src="Imagens/Cabo Usb-C 7.1A Leon 1000mm.png" alt="Cabo C"><h3>Cabo USB-C</h3><p class="preco">R$ 18,00</p></a><a href="arduino.php" class="produto-card"><img src="Imagens/arduino 3.png" alt="Arduino"><h3>Arduino Uno</h3><p class="preco">R$ 55,00</p></a></div></section>
