...
// Detalhes fixos do produto (ID 6)
$PROD_ID = 6;
$PROD_NOME = "Cabo Micro USB para Esp32, Esp8266 e Arduino Leonardo";
$PROD_PRECO = 22.00;
?>
<!DOCTYPE html>
<html lang="pt-br">
...
<body>
    ...
    <main class="produto-container">
        <div class="img-produto">
            <img src="Imagens/Cabo Micro USB para Esp32, Esp8266 e Arduino Leonardo.jpeg" alt="<?= htmlspecialchars($PROD_NOME) ?>">
        </div>

        <div class="info-produto">
            <p class="classificacao">Cabos, Acessórios</p>
            ...
            <p class="descricao">
                O Cabo Micro USB é um item essencial para alimentação e comunicação da sua placa com o PC.
            </p>
