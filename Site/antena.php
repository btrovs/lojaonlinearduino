...
session_start();
$PROD_ID = 7;
$PROD_NOME = "Antena Wi-fi Adaptador Wireless";
$PROD_PRECO = 45.00;
$PROD_IMG = "Imagens/antena.webp"; // Confirme o nome na pasta!
$PROD_CATEGORIA = "Acessórios, Rede";
...
<body>
    ...
    <main class="produto-container">
        ...
        <div class="info-produto">
            ...
            <p class="descricao">Adaptador Wireless USB Wi-Fi de alta velocidade (1800mbps), ideal para conectar seu PC ou Notebook à rede sem fio com estabilidade e longo alcance.</p>
    ...
    <section class="descricao-detalhada">
        ...
        <ul>
            ...
            <li>- Velocidade: Até 1800mbps</li>
            <li>- Frequência: 2.4GHz</li>
            <li>- Compatibilidade: Windows, Linux, Mac OS</li>
            <li>- Antena: Externa Ganho de 5dBi (Rosqueável)</li>
        </ul>
    </section>
